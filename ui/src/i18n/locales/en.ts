...
export const en: TranslationMap = {
  ...
  sessionsView: {
    ...
    pinGlobally: "Pin globally",
    unpinGlobally: "Unpin globally",
    movePinGlobally: "Move pin globally",
    pinInGroup: "Pin in {group}",
    movePinToGroup: "Move pin to {group}",
    unpinFromGroup: "Unpin from {group}",
